...
export const itemInfo: CategoryInfo = {
  ...
  integrationNote:
    `${branding.brandName} Item follows the Tailwind design system closely. Adjusting theme values like hover backgrounds, font sizing, or border radius automatically updates the component styling throughout the interface.`,
  faqs: []
};
