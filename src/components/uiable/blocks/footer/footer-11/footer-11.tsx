...
export default function Footer5() {
  return (
    <footer className="relative overflow-hidden">
      <div className="absolute inset-0 z-10 bg-blue-500/10"></div>
      <div className="absolute inset-x-0 bottom-0 z-20 h-2/4 rounded-t-full bg-blue-500"></div>
      <div className="relative z-30 container mx-auto px-6 py-24 sm:py-32 lg:px-8">
        <motion.div
          ...
          className="rounded-lg bg-card p-5 text-left shadow-[0_0_40px_-8px_#4680ff38] sm:p-14"
        >
            ...
            >
              <div className="flex flex-col gap-3 sm:gap-4">
                ...
                <p className="font-sans text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                  We can&apos;t wait to celebrate our special day with our
                  beloved family and friends. Join us as we begin our forever.
                </p>
              </div>
            </motion.div>
                ...
                {footerColumns.map((col) => (
                  ...
                  >
                    <div className="flex flex-col gap-3 sm:gap-6">
                      ...
                      <div className="h-px w-full bg-blue-100/50 dark:bg-blue-900/20"></div>
                      <ul className="space-y-2 sm:space-y-2.5">
                        {col.links.map((link) => (
                          <li key={link}>
                            <a
                              href="#"
                              className="group flex items-center gap-1.5 text-base text-slate-600 transition-all duration-300 ease-in-out hover:gap-2.5 hover:font-medium hover:text-blue-500 dark:text-slate-400 dark:hover:text-blue-300"
                            >
                              <Minus className="size-4 text-blue-300 transition-all duration-300 ease-in-out group-hover:translate-x-0.5 group-hover:text-blue-500 dark:text-blue-700 dark:group-hover:text-blue-300" />
                              {link}
                            </a>
                          </li>
                        ))}
          ...
          <motion.div
            variants={itemVariants}
            className="my-8 h-px w-full bg-blue-100/50 sm:my-10 dark:bg-blue-900/20"
          ></motion.div>
          <motion.div
            variants={itemVariants}
            className="flex flex-col-reverse items-center gap-4 lg:flex-row lg:gap-6"
          >
            <div className="basis-full lg:basis-2/4">
              <p className="text-center font-sans text-sm text-slate-500 lg:text-left dark:text-slate-400">
                Copyright © 2026 Evie & Alex. All Rights Reserved.
              </p>
            </div>
            <div className="basis-full lg:basis-2/4">
              <div className="flex justify-center gap-3 lg:justify-end">
                {socialIcons.map(({ label, bgClass, svg }) => (
                  <a
                    ...
                    href="#"
                    aria-label={label}
                    className={`inline-flex h-8 w-8 items-center justify-center rounded-lg text-white ${bgClass} transition-all duration-500 hover:-translate-y-1 hover:shadow-md`}
                  >
                    {svg}
                  </a>
                ))}
