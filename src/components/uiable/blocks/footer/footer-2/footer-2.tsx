...
export default function Footer1() {
  return (
    <footer className="relative overflow-hidden">
      <div className="absolute inset-0 z-10 bg-linear-to-t from-pink-100 to-pink-50 dark:from-pink-950 dark:to-pink-900"></div>
      <div className="relative z-30 container mx-auto px-6 py-24 sm:py-32 lg:px-8">
          ...
          <div className="col-span-12 lg:col-span-3">
            <div className="flex flex-col gap-3 sm:gap-4">
              <div className="flex flex-row items-center gap-3">
                ...
                <span className="text-lg font-medium text-slate-900 sm:text-xl dark:text-mauve-100">
                  SaaSify
                </span>
              </div>
              <p className="text-slate-600 dark:text-mauve-400">
                Built for modern teams to organize projects, automate workflows,
                and collaborate. Make smarter, data-driven decisions.
              </p>
            </div>
          </div>
              ...
              {footerColumns.map((col) => (
                ...
                >
                  <div className="flex flex-col gap-3 sm:gap-6">
                    <div className="text-lg font-medium text-slate-900 dark:text-mauve-100">
                      {col.title}
                    </div>
                    <ul className="space-y-2 sm:space-y-2.5">
                      {col.links.map((link) => (
                        <li key={link}>
                          <a
                            href="#"
                            className="group flex items-center gap-1.5 text-base text-slate-600 transition-all duration-300 ease-in-out hover:gap-2.5 hover:font-medium hover:text-pink-500 dark:text-mauve-400 dark:hover:text-pink-300"
                          >
                            <ChevronRight className="size-4 transition-all duration-300 ease-in-out group-hover:translate-x-0.5" />
                            {link}
                          </a>
                        </li>
                      ))}
      ...
      <div className="relative z-30">
        <div className="container mx-auto mask-b-from-0% mask-b-to-96 mask-exclude mask-match px-6 text-center lg:px-8">
          <span className="text-[18cqw] leading-none font-light text-pink-600">
            SaaSify
          </span>
        </div>
      </div>
      <div className="relative z-30 border-t border-pink-200 dark:border-pink-800">
        <div className="container mx-auto px-6 py-5 lg:px-8">
          <div className="flex flex-col-reverse items-center gap-2 lg:flex-row lg:gap-6">
            <div className="basis-full lg:basis-2/4">
              <p className="text-center text-slate-600 lg:text-left dark:text-mauve-400">
                Copyright © 2026 SaaSify. All Rights Reserved
              </p>
            </div>
            <div className="basis-full lg:basis-2/4">
              <div className="flex justify-center gap-2 lg:justify-end">
                {socialIcons.map(({ label, bgClass, svg }) => (
                  <a
                    key={label}
                    href="#"
                    aria-label={label}
                    className={`inline-flex h-8 w-8 items-center justify-center text-slate-400 dark:text-mauve-400 ${bgClass} transition-all duration-500 hover:-translate-y-1`}
                  >
                    {svg}
                  </a>
                ))}
