...
export default function Footer1() {
  return (
    <footer className="relative overflow-hidden bg-linear-to-t from-slate-900 to-slate-800 py-24 sm:py-32">
      <div className="container mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 lg:col-span-3">
            <div className="flex flex-col gap-3 sm:gap-4">
              <svg
                className="size-16 fill-cyan-500"
                viewBox="0 0 256 256"
                id="Flat"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <p className="max-w-150 text-slate-400">
                    ...
                    <ul className="space-y-2 sm:space-y-2.5">
                      {col.links.map((link) => (
                        <li key={link}>
                          <a
                            href="#"
                            className="group flex items-center gap-1.5 text-base text-slate-400 transition-all duration-300 ease-in-out hover:gap-2.5 hover:font-medium hover:text-cyan-500"
                          >
                  ...
                  <div className="flex flex-col gap-3 sm:gap-6">
                    ...
                    <div className="flex flex-col gap-3">
                      <div className="dark relative w-full">
                        ...
                        <Input
                          className="rounded-lg border-0 bg-slate-800 pl-12 placeholder:text-slate-400 focus:border-none dark:focus:border-none"
                          type="text"
                        ...
                        <div className="absolute inset-y-0 right-0 flex items-center pr-1.5">
                          <Button
                            size="icon"
                            className="rounded-lg border-0 bg-cyan-500"
                          >
                            <svg
                              className="size-5"
                              xmlns="http://www.w3.org/2000/svg"
