...
export default function Hero6() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-900 pt-6 sm:pt-12">
      <div className="absolute inset-0 z-10 bg-linear-to-t from-slate-900/50 to-sky-500 opacity-60"></div>
      <div
        aria-hidden="true"
      ...
      <div className="relative z-30 container mx-auto px-6 lg:px-8">
        <div className="flex flex-col items-center gap-10">
          <div className="relative rounded-full bg-slate-900/50 p-3 pl-6 shadow-[0_0_40px_-8px_#4680ff38] backdrop-blur-md max-md:w-full">
            <div className="flex flex-row items-center justify-between gap-10">
              <div className="flex flex-row items-center gap-3">
                ...
                <span className="text-lg font-medium sm:text-xl">
                  <span className="text-lime-500">Zoro</span>
                ...
                {isOpen && (
                  ...
                  >
                    <div className="mt-2 flex flex-col gap-2 rounded-2xl bg-card p-4 shadow-[0_0_40px_-8px_#4680ff38] backdrop-blur-md">
                      ...
                      <Button className="rounded-full border-0 border-b-2 border-b-slate-900 bg-slate-800 lg:flex">
                        Buy Now
                      </Button>
                    </div>
                  </motion.div>
              ...
              <div className="hidden flex-row gap-2 text-slate-100 md:flex">
                {navLinks.map((item) => (
                  <a
                    key={item.name}
                    className="hover:bg-text-500/10 rounded-full px-3 py-1.5 hover:text-lime-500"
                    href={item.href}
                  >
                    {item.name}
                  </a>
              ...
              <Button className="hidden rounded-full border-0 border-b-2 border-b-slate-900 bg-slate-800 hover:translate-y-1 hover:opacity-90 md:flex">
                Buy Now
              </Button>
              <div className="flex md:hidden">
                <Button
                  size="icon-lg"
                  className="bg-limw-500 rounded-full shadow-[0_8px_10px_-2px_#8f8f8f6b]"
          ...
          <div className="grid w-full grid-cols-12 gap-8">
            <div className="col-span-12 flex flex-col items-center text-center md:col-span-8 md:col-start-3">
              <div className="flex flex-col items-center gap-2 text-center sm:gap-5">
                <div className="flex items-center gap-4">
                  <div className="h-0.5 w-20 rounded-full bg-linear-to-r from-transparent to-lime-500 sm:w-25"></div>
                  <span className="text-md font-semibold text-lime-500 sm:text-lg">
                    Download Our App
                  </span>
                  <div className="h-0.5 w-20 rounded-full bg-linear-to-r from-lime-500 to-transparent sm:w-25"></div>
                </div>
                <div className="flex flex-col items-center gap-1 sm:gap-2">
                  <h1 className="text-lg font-medium text-slate-100 sm:text-4xl">
                    Download Our App Today Free
                  </h1>
                  <h2 className="text-lg font-medium text-slate-100 sm:text-4xl">
            ...
            <div className="relative col-span-12 flex items-center justify-center">
              <div className="absolute inset-x-0 px-6 text-center lg:px-8">
                <span className="mask-t-from-5% mask-t-to-95% mask-exclude mask-match text-[18cqw] leading-none font-medium text-white">
                  ZoroApp
                </span>
              </div>
