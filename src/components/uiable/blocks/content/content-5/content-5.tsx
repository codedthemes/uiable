  ...
  return (
    <div className="p-0">
      <div className="relative flex items-center">
        <div className="absolute inset-y-0 left-0 block w-full bg-[url(https://cdn.uiable.com/block/img-content-3.jpg)] bg-cover bg-center xl:w-2/4"></div>
        <div className="z-20 container mx-auto grid grid-cols-12">
          <div className="col-span-12 xl:col-span-6"></div>
          <div className="col-span-12 px-3 py-16 sm:py-24 lg:py-32 xl:col-span-6">
            <div className="relative mx-auto flex max-w-110 flex-col items-center gap-7 rounded-2xl text-center max-xl:bg-card/70 max-xl:px-5 max-xl:py-10 max-xl:backdrop-blur-2xl">
              <svg
                className="size-14 text-cyan-700"
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="max-w-100 text-slate-600 dark:text-slate-400">
                  ...
                  daily operations while keeping your data secure, accessible,
                  and easy to manage.
                </p>
              </div>
              <Button
                size="lg"
                className="rounded-full bg-cyan-700 hover:translate-y-1 hover:opacity-90"
              >
                Get Started
              </Button>
            </div>
      ...
      <div className="relative flex items-center">
        <div className="absolute inset-y-0 right-0 block w-full bg-[url(https://cdn.uiable.com/block/img-content-4.jpg)] bg-cover bg-center xl:w-2/4"></div>
        <div className="z-20 container mx-auto grid grid-cols-12">
          <div className="col-span-12 px-3 py-16 sm:py-24 lg:py-32 xl:col-span-6">
            <div className="relative mx-auto flex max-w-110 flex-col items-center gap-7 rounded-2xl text-center max-xl:bg-card/70 max-xl:px-5 max-xl:py-10 max-xl:backdrop-blur-2xl">
              <svg
                className="size-14 text-amber-600"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="none"
              >
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="max-w-100 text-slate-600 dark:text-slate-400">
                  ...
                  efficiently from a single powerful platform. Boost
                  productivity with real-time analytics, seamless integrations,
                  and scalable cloud infrastructure.
                </p>
              </div>
              <Button
                size="lg"
                className="rounded-full bg-amber-600 hover:translate-y-1 hover:opacity-90"
              >
                Start Free Trial
              </Button>
            </div>
