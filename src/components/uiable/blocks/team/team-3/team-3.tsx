...
const users = [
  {
    ...
    description:
      "Lead UX Designer specializing in creating intuitive, user-centric interfaces and modern design systems. Experienced in user research, wireframing, prototyping, accessibility standards, and collaborating closely with developers to deliver seamless digital experiences that improve customer satisfaction and engagement.",
  },
  {
    id: 2,
    name: "Michael Chen",
    ...
    description:
      "Senior Full-Stack Engineer focused on building scalable backend architectures and robust APIs. Skilled in modern JavaScript frameworks, cloud services, database optimization, microservices, and delivering secure, high-performance applications that support millions of users.",
  },
  {
    id: 3,
    name: "David Ross",
    ...
    description:
      "Data Scientist with expertise in predictive modeling, machine learning, and business intelligence analytics. Passionate about transforming complex datasets into actionable insights, developing AI-driven solutions, and helping organizations make data-informed strategic decisions.",
  },
  {
    id: 4,
    name: "Emily Watson",
    ...
    description:
      "Product Manager passionate about driving product strategy, cross-functional collaboration, and user growth. Experienced in roadmap planning, stakeholder communication, market analysis, agile methodologies, and delivering innovative products that align with business goals and customer needs.",
  },
  {
    id: 5,
    ...
    description:
      "Security Specialist dedicated to implementing advanced encryption, compliance standards, and risk mitigation. Experienced in vulnerability assessments, threat detection, identity management, security audits, and developing resilient cybersecurity strategies to protect enterprise infrastructure.",
  },
  {
    id: 6,
    ...
    description:
      "DevOps Engineer expert in automating deployment pipelines, cloud infrastructure orchestration, and CI/CD. Proficient in containerization, Kubernetes, infrastructure as code, monitoring solutions, and optimizing development workflows to ensure reliable and efficient software delivery.",
  },
  {
    id: 7,
    ...
    description:
      "QA Automation Engineer focused on comprehensive test coverage, performance testing, and bug prevention. Experienced in designing scalable automation frameworks, continuous testing, regression analysis, and ensuring software quality through reliable testing practices and detailed reporting.",
  },
  {
    id: 8,
    name: "James Wilson",
    ...
    description:
      "Solutions Architect with a track record of integrating complex enterprise systems and software solutions. Skilled in cloud architecture, technical consulting, infrastructure planning, solution design, and guiding organizations through successful digital transformation initiatives with scalable technologies.",
  },
]
const socialLinks = [
  {
...
export default function Team3() {
  ...
  const wrap = (i: number) => ((i % users.length) + users.length) % users.length
  ...
  const activeIndex = wrap(current)
  const activeMember = users[activeIndex]
        ...
        <div className="flex flex-col items-center gap-5 sm:gap-12">
          ...
          <div className="flex w-full flex-col gap-10">
            ...
            >
              <CarouselContent className="items-center">
                {users.map((user, index) => {
                  ...
                  return (
                    <CarouselItem
                      key={user.id}
                      className="flex basis-1/3 justify-center pl-4"
                    >
                      <div
                        className={cn(
                          "flex size-25 items-center overflow-hidden rounded-full transition-all duration-500 md:size-36",
                      ...
                      >
                        <Avatar
                          className={cn(
                            ...
                            isActive ? "size-25! md:size-36!" : "size-20!"
                          )}
                        >
              ...
              <CarouselPrevious className="left-[calc(33%-1.5rem)] size-10 -translate-y-2/4 rounded-full border-0 border-b-2 border-b-sky-700 bg-sky-500 text-white hover:bg-sky-600 hover:text-white max-md:hidden dark:hover:bg-sky-600 dark:hover:text-white [&_svg:not([class*='size-'])]:size-6" />
              <CarouselNext className="right-[calc(33%-1.5rem)] size-10 -translate-y-2/4 rounded-full border-0 border-b-2 border-b-sky-700 bg-sky-500 text-white hover:bg-sky-600 hover:text-white max-md:hidden dark:hover:bg-sky-600 dark:hover:text-white [&_svg:not([class*='size-'])]:size-6" />
            </Carousel>

            <div className="relative z-40 mx-auto h-full max-w-215 overflow-hidden rounded-sm bg-card p-5 shadow-[0_0_40px_-8px_#4680ff38] sm:px-8 sm:py-12 dark:shadow-none">
              <div className="flex flex-col items-center gap-8 text-center">
                <div className="flex flex-col items-center gap-1">
                  <h2 className="text-lg font-medium text-slate-800 sm:text-xl dark:text-slate-50">
                    {activeMember.name}
                  </h2>
                  <a href={`mailto:${activeMember.mail}`} className="group">
                ...
                <div
                  className={
                    "h-0.75 w-20 rounded-lg " + activeMember.colorClass
                  }
                ></div>
                <div className="flex justify-center gap-2">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className={`inline-flex h-10 w-10 items-center justify-center rounded-full ${social.bgColor} text-white transition-all duration-500 hover:-translate-y-1.5 hover:shadow-md`}
                    >
                      {social.icon}
                    </a>
                  ))}
                </div>
                <p className="line-clamp-4 text-slate-600 dark:text-slate-100">
