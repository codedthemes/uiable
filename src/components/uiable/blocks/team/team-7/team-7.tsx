const socialIcons = [
  {
    ...
    svg: (
      ...
      >
        <g clipPath="url(#clip0_255_10818)">
          <path
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <g clipPath="url(#clip0_255_10822)">
          <path
            ...
            {users.map((user, idx) => (
              ...
              >
                <div className="relative h-full overflow-hidden rounded-[24px] bg-card shadow-[0_0_40px_-8px_#4680ff38] dark:shadow-none">
                  ...
                  ></div>
                  <div className="relative z-20 rounded-[22px] bg-card/95 p-3">
                    <div className="flex flex-col gap-0">
                      ...
                      />
                      <div className="relative z-10 -mt-1 flex flex-col items-center gap-4 rounded-2xl bg-card p-6 shadow-[0_0_8px_-1px_#4680ff38]">
                        ...
                        <div className="flex gap-2">
                          {socialIcons
                            .filter(({ label }) => {
                              if (!user.socials) return true
                              return (
                                user.socials[
                                  label as keyof typeof user.socials
                                ] ?? false
                              )
                            })
                            .map(({ label, bgClass, svg }) => (
                              <a
                                key={label}
                                href="#"
                                aria-label={label}
                                className={`inline-flex h-10 w-10 items-center justify-center rounded-full bg-slate-300 text-white dark:bg-slate-700 ${bgClass} transition-all duration-500 hover:-translate-y-1 hover:shadow-md`}
                              >
                                {svg}
                              </a>
                            ))}
