...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-card group/calendar p-2 [--cell-radius:calc(var(--radius)+4px)] [--cell-size:--spacing(7)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
