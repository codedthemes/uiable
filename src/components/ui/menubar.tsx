...
function Menubar({ className, ...props }: MenubarPrimitive.Props) {
  return (
    <MenubarPrimitive
      data-slot="menubar"
      className={cn(
        "bg-background flex h-10 items-center gap-0.5 rounded-lg border border-border p-3",
        className
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <DropdownMenuTrigger
      ...
      className={cn(
        "hover:bg-background aria-expanded:bg-card aria-expanded:shadow-md flex items-center rounded-lg px-3 py-1 text-base font-medium outline-hidden select-none",
        className
      )}
      {...props}
    />
...
function MenubarCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-background focus:text-accent-foreground focus:**:text-accent-foreground relative flex cursor-default items-center gap-1.5 rounded-lg py-1.5 pr-1.5 pl-7 text-base outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:pl-7 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      checked={checked}
      {...props}
...
function MenubarSubTrigger({
  ...
  return (
    <DropdownMenuSubTrigger
      ...
      data-inset={inset}
      className={cn(
        "focus:bg-background hover:bg-background focus:text-accent-foreground data-open:bg-background data-open:text-accent-foreground gap-1.5 rounded-lg px-2 py-1.5 text-base data-inset:pl-7 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
